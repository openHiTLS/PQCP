...
McelieceParams *McelieceGetParamsById(const PQC_Mceliece_AlgWithParamId algID)
{
    const int32_t base = PQC_ALG_ID_MCELIECE_6688128;
    const int32_t max = PQC_ALG_ID_MCELIECE_8192128_PCF;

    if ((unsigned)(algID - base) > (max - base))
    {
        return NULL;
    }
