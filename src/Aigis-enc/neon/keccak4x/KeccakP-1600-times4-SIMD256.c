...
#if 1 /* originally: defined(KeccakP1600times4_useAVX2), now always on for NEON compat */
    #define ANDnu256(a, b)          _mm256_andnot_si256(a, b)
    #define CONST256(a)             _mm256_load_si256((const V256 *)&(a))
    #define CONST256_64(a)          _mm256_set1_epi64x((int64_t)(a))
...
static const UINT64 rho56[4] = {0x0007060504030201, 0x080F0E0D0C0B0A09, 0x1017161514131211, 0x181F1E1D1C1B1A19};
    ...
    #define STORE2_128(ah, al, v)   _mm256_storeu2_m128d(&(ah), &(al), v)
    ...
    #define SHUFFLE64( a, b, c )    _mm256_shuffle_pd_epi64((a), (b), c)
