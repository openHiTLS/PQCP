...
#define AIGIS_SIG_SIGNATURE_BYTES(seedBytes, k, l, w, zBytes) \
    ((l) * (zBytes) + (seedBytes) + 1U + AIGIS_SIG_HINT_COUNT_BYTES(k) + AIGIS_SIG_HINT_POSITION_BYTES(w))
...
#define AIGIS_SIG_PARAM_I_SIGNATURE_BYTES      AIGIS_SIG_SIGNATURE_BYTES(32U, 2U, 2U, 72U, 960U)
...
#define AIGIS_SIG_PARAM_II_SIGNATURE_BYTES     AIGIS_SIG_SIGNATURE_BYTES(32U, 4U, 4U, 176U, 1088U)
...
#define AIGIS_SIG_PARAM_III_SIGNATURE_BYTES    AIGIS_SIG_SIGNATURE_BYTES(64U, 8U, 7U, 102U, 1280U)
