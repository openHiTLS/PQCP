...
/* Ensure the AVX2-emulation code path is enabled on ARM */
#ifndef KeccakP1600times4_useAVX2
#define KeccakP1600times4_useAVX2
#endif

#include "brg_endian.h"
#if !defined(PLATFORM_BYTE_ORDER) || !defined(IS_LITTLE_ENDIAN)
  /* ARM64 is little-endian; bypass check if brg_endian.h cannot detect */
